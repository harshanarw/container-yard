...
class DefaultCoaSeeder extends Seeder
{
    ...
    private function accountData(): array
    {
        return [
            ...
            ['code' => '4008', 'name' => 'Demurrage & Detention Income','classification' => 'income', 'normal_balance' => 'credit', 'parent' => '4000', 'is_posting' => true, 'is_system' => true, 'sort_order' => 308],
            ['code' => '4009', 'name' => 'Overtime (OT) Revenue',      'classification' => 'income', 'normal_balance' => 'credit', 'parent' => '4000', 'is_posting' => true, 'is_system' => true, 'sort_order' => 309],
