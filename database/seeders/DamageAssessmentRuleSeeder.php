...
class DamageAssessmentRuleSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rules = [
            ...
            $rule('Floor Board — Surface Rust / Treat & Paint',         'FL', 'FLB', 'RST', 'TAP', 'minor',    'Surface corrosion on floor boards'),
            ...
            $rule('Cross Member — Rust / Treat & Paint',                'CM', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on under-floor cross members'),
            ...
            $rule('Roof Panel — Rust / Treat & Paint',                  'RF', 'PNL', 'RST', 'TAP', 'minor',    'Surface corrosion on roof panel'),
            ...
            $rule('Roof Rail — Rust / Treat & Paint',                   'RF', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on roof rail'),
            ...
            $rule('Left Side Panel — Rust / Treat & Paint',             'SWL', 'PNL', 'RST', 'TAP', 'minor',    'Surface rust on left side panel'),
            ...
            $rule('Left Side Rail — Rust / Treat & Paint',              'SWL', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on left side rail'),
            ...
            $rule('Right Side Panel — Rust / Treat & Paint',            'SWR', 'PNL', 'RST', 'TAP', 'minor',    'Surface rust on right side panel'),
            ...
            $rule('Right Side Rail — Rust / Treat & Paint',             'SWR', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on right side rail'),
            ...
            $rule('Front Wall Panel — Rust / Treat & Paint',            'FW', 'PNL', 'RST', 'TAP', 'minor',    'Corrosion on front wall panel'),
            ...
            $rule('Front Rail — Rust / Treat & Paint',                  'FW', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on front rail'),
            ...
            $rule('Left Door — Rust / Treat & Paint',                   'DL', 'DOR', 'RST', 'TAP', 'minor',    'Surface corrosion on left door'),
            ...
            $rule('Left Door Sill — Rust / Treat & Paint',              'DL', 'SIL', 'RST', 'TAP', 'minor',    'Corrosion on door sill'),
            ...
            $rule('Right Door — Rust / Treat & Paint',                  'DR', 'DOR', 'RST', 'TAP', 'minor',    'Surface corrosion on right door'),
            ...
            $rule('Right Door Sill — Rust / Treat & Paint',             'DR', 'SIL', 'RST', 'TAP', 'minor',    'Corrosion on right door sill'),
            ...
            $rule('Corner Post — Rust / Treat & Paint',                 'CP', 'PST', 'RST', 'TAP', 'minor',    'Corrosion on corner post'),
            ...
            $rule('Base Rail — Rust / Treat & Paint',                   'BR', 'RAL', 'RST', 'TAP', 'minor',    'Corrosion on base rail'),
            ...
            $rule('Rear Sill — Rust / Treat & Paint',                   'RS', 'SIL', 'RST', 'TAP', 'minor',    'Corrosion on rear door sill'),
            ...
            $rule('Under Structure — Rust / Treat & Paint',             'US', 'RAL', 'RST', 'TAP', 'minor',    'General corrosion on under-frame structure'),
