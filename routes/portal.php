...
Route::prefix('portal')->name('portal.')->group(function () {
    ...
    Route::get('estimate/{token}/approval-form',                              [PortalEstimateController::class, 'approvalForm'])->name('estimate.approval-form');
    Route::post('estimate/{token}/upload-signed',                             [PortalEstimateController::class, 'uploadSignedApproval'])->name('estimate.upload-signed');
    Route::get('estimate/{token}/signed-doc/{document}/view',                 [PortalEstimateController::class, 'viewSignedDoc'])->name('estimate.signed-doc.view');
    ...
    Route::get('estimate/{token}/photos/{document}/download',   [PortalEstimateController::class, 'downloadPhoto'])->name('estimate.photo.download');
});
