        ...
        fetch(form.action, { method: 'POST', body: fd, redirect: 'follow', headers: { 'X-Requested-With': 'XMLHttpRequest' } })
            .then(function (response) {
                ...
                if (finalUrl.indexOf('gate-pass') !== -1) {
                    ...
                    // Open the gate pass print preview in its own window; the
                    // WhatsApp "Send to Driver" button lives in that preview's
                    // toolbar (a single tap opens WhatsApp reliably — auto-opening
                    // both a popup and WhatsApp is blocked by browsers).
