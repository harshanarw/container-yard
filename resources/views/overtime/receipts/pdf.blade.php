...
<style>
    ...
    * { box-sizing: border-box; }
    ...
    /* DomPDF positions a fixed element against the content box, which the
       ...
       letterhead 132px down the page. The negative offset lifts it back
       into the band those margins reserved for it. */
    .pdf-fixed-header { position: fixed; top: -132px; left: 0; right: 0; padding: 14px 24px 0; background: #fff; }
