...
<div class="page-header d-flex align-items-start justify-content-between flex-wrap gap-2">
    ...
    <div class="d-flex gap-2 flex-wrap">
        ...
        @endif
        <a href="{{ route('inquiries.edit', $inquiry) }}" class="btn btn-primary btn-sm">
...
<div class="row g-4">
    ...
    <div class="col-lg-8">
        ...
        {{-- Container & Inquiry Details --}}
        <div class="card content-card mb-4">
            <div class="card-header py-2 fw-semibold small">
                <i class="bi bi-box-seam me-2 text-primary"></i>Container & Inquiry Details
            </div>
            <div class="card-body">
    ...
    <div class="col-lg-4">
        ...
        <div class="card content-card mb-4">
            ...
            <div class="card-body d-grid gap-2">
                <a href="{{ route('inquiries.edit', $inquiry) }}" class="btn btn-primary btn-sm">
                    <i class="bi bi-pencil me-2"></i>Edit Inquiry
                </a>
                @if(!$inquiry->estimate)
                <a href="{{ route('estimates.create', ['inquiry_id' => $inquiry->id]) }}"
                   class="btn btn-warning btn-sm">
        ...
        <div class="modal-content">
            <form method="POST" action="{{ route('inquiries.destroy', $inquiry) }}">
                ...
                <div class="modal-header border-0">
                    <h5 class="modal-title text-danger"><i class="bi bi-exclamation-triangle me-2"></i>Delete Inquiry</h5>
