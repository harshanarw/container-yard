...
<div class="page-header d-flex align-items-center justify-content-between">
    ...
    <div class="d-flex flex-wrap gap-2 no-print">
        ...
        <a href="{{ route('reports.billing.export', request()->query()) }}" class="btn btn-outline-success btn-sm">
            <i class="bi bi-filetype-csv me-1"></i>Export CSV
        </a>
        @if(\App\Support\Export\TabularExport::supports('xlsx'))
        <a href="{{ route('reports.billing.export', array_merge(request()->query(), ['format' => 'xlsx'])) }}"
