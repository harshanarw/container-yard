    ...
    <form method="POST" action="{{ route('finance.vouchers.pay.store') }}" id="payForm">
        ...
        <div class="card content-card">
            <div class="card-header bg-transparent py-2 d-flex justify-content-between align-items-center">
                ...
                <span class="small">
                    Total to pay: <span class="fw-bold font-monospace" id="totalDisplay">0.00</span> <span id="ccyLabel">{{ $baseCurrency }}</span>
                ...
                <table class="table table-sm align-middle mb-0 small">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-end" style="width:160px;">Amount to Pay <span class="hdr-ccy text-muted fw-normal"></span></th>
                        </tr>
                    </thead>
                    <tbody>
            ...
            <div class="border-top px-3 py-2 bg-light-subtle">
                <div class="row g-2 align-items-end justify-content-end">
                    <div class="col-md-3 col-6">
                        <label class="form-label small mb-1 fw-semibold">WHT Nature</label>
                        <select name="wht_type" id="whtType" class="form-select form-select-sm">
                            <option value="">— No WHT —</option>
                            @foreach(collect(config('wht.types', []))->where('applies', '!=', 'ar') as $t)
                    ...
                    <div class="col-md-4 col-12 text-md-end">
                        <div class="small text-muted">Net paid to supplier</div>
...
(function () {
    ...
    function applyCurrencyFilter() {
        ...
        document.querySelectorAll('tr[data-currency]').forEach(tr => {
            ...
            // bill currency differs from the voucher currency.
