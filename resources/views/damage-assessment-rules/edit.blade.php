...
@section('title', 'Edit Assessment Rule')
...
<div class="page-header d-flex align-items-center justify-content-between mb-4">
    <div>
        <h4><i class="bi bi-journal-pen me-2 text-primary"></i>Edit Assessment Rule</h4>
        <p class="text-muted small mb-0">{{ $rule->name }}</p>
    </div>
...
<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                <form method="POST" action="{{ route('masters.damage-assessment-rules.update', $rule) }}">
                    @csrf @method('PUT')
                    @include('damage-assessment-rules._form', ['rule' => $rule])
