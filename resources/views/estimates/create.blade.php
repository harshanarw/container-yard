                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <textarea name="send_to_email" class="form-control form-control-sm" rows="2"
                                  placeholder="customer@email.com">{{ old('send_to_email', $selectedInquiry->customer->email ?? '') }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="send_cc_email" class="form-control form-control-sm" rows="2"
                                  placeholder="manager@email.com">{{ old('send_cc_email') }}</textarea>
                        <div class="form-text">Separate multiple addresses with a comma, semicolon, or new line.</div>
                    </div>
                    <div class="mb-2">
...
(function () {
    ...
    // Live reconvert while typing the rate (keyup), not only on blur. Snapshot the
    // line amounts on focus, then rescale from that stable snapshot on every input
    // so intermediate digits (30 → 305) don't compound.
    (function () {
        ...
        rateEl.addEventListener('input', () => {
            ...
            if (rateEl.value.trim() === '') return;          // don't collapse while the field is empty
